        ...
        <div class="panel panel-info" >
            ...
            <div style="padding-top:10px" class="panel-body" >
                <form id="loginForm" name='loginForm' novalidate="novalidate" class="form-horizontal" role="form" method='POST'>
                    ...
                    <div class="form-group">
                        <label for="adsl" class="control-label">Velocidad Adsl (MB)</label>
                        <div style="display: block">
                            <input id="datos" name="adsl" type="text" class="span2" value="" data-slider-min="0" 
                                   data-slider-max="400" data-slider-step="10" data-slider-value="0" 
                                   data-slider-orientation="horizontal" data-slider-selection="after"
                                   data-slider-tooltip="show">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="checkbox">
                            <label>
                                <input type="checkbox" id="fijo" value="fijo" name="fijo">
                                Fijo
                            </label>
                        </div>
                    </div>
